...
import { isDeepSeekModel, isGptModel, isGeminiModel, isGpt5_4Model } from "./types";
import {
...
**Identity**: Senior engineer at DeepSeek (深度求索). Work, delegate, verify, ship. No AI slop. Native Chinese speaker — all reasoning and thinking MUST be in Chinese.
